     ...
     <script>
	     ...
	     $("#postRegistcancel").click (function(){
   	   ...
   	   $("#lCategory").change(function(){
            ...
            var x = $(this).val();
            $.ajax({
				url: "${ pageContext.servletContext.contextPath }/post/regist/scategory",
				type: "get",
				data: {lcategory : x},
				success: function(data){
					...
					$("#sCategory").html(" ");
					$("#sCategory").append("<option value=\"\">소분류</option>");
					  for(var i = 0 ; i < data.length ; i++){
						 $("#sCategory ").append("<option value=\""+ data[i].ctgSCode+"\">"+ data[i].ctgSName +"</option>");
					}  
